    ...
    try {
      ...
      if (data) {
        setSession({
          ...
          session_name: data.instance_name, // Alias
          status: data.status || 'disconnected',
          qr_code: data.qr_code || undefined,
          qr_expires_at: data.qr_expires_at || undefined,
          ...
          disconnected_at: data.disconnected_at || undefined,
          total_messages_sent: data.total_messages_sent || 0,
          total_messages_received: data.total_messages_received || 0,
